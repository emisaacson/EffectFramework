...
namespace Local.Classes.Helpers
{
    public class ModelPropertyInfoHelper
    {
        ...
        public static FieldInfo GetSSFieldInfo(PropertyInfo property)
        {
            ...
            Local.Classes.UserContext.FACL[] facl = DBHelper.GetCurrentUserContext().GetUserFACLArray();
            Local.Classes.UserContext.FACL field = facl.FirstOrDefault(x => x.FieldName == FieldName && x.Modelname == SectionName);
